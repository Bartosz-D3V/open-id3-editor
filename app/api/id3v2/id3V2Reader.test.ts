...
describe('ID3V2Reader', () => {
  describe('readID3V2 function', () => {
    it('should create ID3V2 object from DataView from real MP3 file', async () => {
      const data1: Buffer = await FsUtil.readFile(`${mocksDir}/ID3V20/id3v2_001_basic.mp3`);
      ...
      const data2: Buffer = await FsUtil.readFile(`${mocksDir}/ID3V20/id3v2_002_genre.mp3`);
